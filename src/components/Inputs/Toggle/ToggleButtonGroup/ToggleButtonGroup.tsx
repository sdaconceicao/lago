...
export interface ToggleButtonGroupProps extends RACToggleButtonGroupProps {
   ...
   * default) is 36px tall, and `"lg"` is 48px tall. The group's size wins over
   ...
   * inside a compact field — but the steps mirror the field scale numerically,
   * so `size="md"` lines up with a default (36px) field.
   *
   * @default 'md'
   */
  size?: "sm" | "md" | "lg";
